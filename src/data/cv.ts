export const experiences = [
	{
		company: 'Closing the Gap in Non-Latin Script Data',
		time: '2024–present',
		title: 'WiMi',
		location: 'Berlin',
		description: '',
	...
	{
		company: 'ZODIAC – Ancient Astral Science in Transformation',
		time: '2021–present',
		title: 'WiMi',
		location: 'Berlin',
		description: 'Creator of the Zodiac Glossary—a free, online multilinguistic research tool for the study of ancient astral terms',
	},
	{
		company: 'The Institute for the Study of the Ancient World',
		time: '2019–2021',
		title: 'CLIR Postdoctoral Fellow in the Digital Humanities',
		location: 'New York',
		description: '',
	},
	// {
